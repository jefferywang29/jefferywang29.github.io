...
<div class="p-4">
    ...
    <h6 class="mt-3" style="border-bottom:1px solid #7a0019; display:inline-block; padding-bottom:2px;">
    Teaching Evaluation Highlights</h6>
    <ul>
        <li><strong>95%</strong> of respondents reported they would be likely or very likely to recommend the course</li>
        <li><strong>Overall instructor rating:</strong> 4.2 / 5 (“outstanding”)</li>
        <li><strong>Instructor availability:</strong> 3.6 / 4, exceeding institutional averages</li>
        <li>Student comments consistently highlight clarity of explanation, approachability, and the ability to connect data concepts to real-world examples</li>
    </ul>
    <a href="{{ site.baseurl }}/assets/files/I123_Syllabus.pdf"
        target="_blank" rel="noopener">
        📄 Course Syllabus (PDF)
    </a>
    <a href="{{ site.baseurl }}/assets/files/Evaluation_Data_Fluency.pdf"
        target="_blank" rel="noopener">
    ...
    <a href="{{ site.baseurl }}/assets/files/Evaluation_Global_Governance.pdf"
        target="_blank" rel="noopener">
        📝 Teaching Evaluation (PDF)
    </a>
